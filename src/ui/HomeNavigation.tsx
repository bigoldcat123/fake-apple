...
export default function HomeNavigation({data} : {data:{
    ...
    return (
        <>
            <div ref={head} className=" overflow-hidden scale-y-100 relative z-[3] backdrop-blur-md justify-center" style={{ height: '2.5rem', position: pathName == '/' ? 'fixed' : 'absolute', width: '100%', transition: 'height 0.5s ease-in-out' }}>
