        ...
        <>
            <div ref={head} className=" overflow-hidden scale-y-100 relative z-[3] backdrop-blur-md justify-center" style={{ height: '2.5rem', position: pathName == '/' ? 'fixed' : 'absolute', width: '100%', transition: 'height 0.3s ease-in-out' }}>
                <div className=" text-[0.72rem] font-[540] mx-auto  w-[1005.53px] " style={{ zIndex: '100', alignItems: 'center', display: 'flex', gap: '3rem', height: '2.5rem', justifyContent: 'center', position: 'relative' }}>
                    ...
                    <div className=" cursor-pointer" onClick={() => {hideBannerWithoutAnimation(0)}} onMouseEnter={(e) => showBanner(0)}><Link href={'/store'}>商店</Link></div>
                    ...
                    <div className=" cursor-pointer" onClick={() => {hideBannerWithoutAnimation(0)}} onMouseEnter={(e) => showBanner(7)}>家居</div>
                    <div className=" cursor-pointer" onClick={() => {hideBannerWithoutAnimation(0)}} onMouseEnter={(e) => showBanner(8)}>娱乐</div>
                    <div className=" cursor-pointer" onClick={() => {hideBannerWithoutAnimation(0)}} onMouseEnter={(e) => showBanner(9)}>配件</div>
                    <div className=" cursor-pointer" onClick={() => {hideBannerWithoutAnimation(0)}} onMouseEnter={(e) => showBanner(10)}>技术支持</div>
