        ...
        <div ref={root}>
            <div className="an-test text-[0.7rem] py-12 my-0 mx-auto w-[78rem]  flex flex-row justify-around" >
                ...
                <div className=" cursor-pointer">
                    ...
                    <div><p className="pt-1  text-center">显示器</p></div>
                </div>
                <div className=" cursor-pointer">
                    <div>
                        <svg height="54" viewBox="0 0 34 54" width="34" xmlns="http://www.w3.org/2000/svg"><path d="m0 0h34v54h-34z" fill="none" /><path d="m17 16.5438c9.9364 0 16.5 7.0705 16.5 17.7588 0 4.9229-1.4384 10.3414-3.8522 14.554-.248.4626-.7275.6278-1.2069.4791-.6944 1.0573-1.8848 1.4537-3.2735 1.0573-1.7194-.5121-2.4965-1.9659-1.984-3.7004l2.4469-8.0452c.5125-1.7015 1.9344-2.478 3.6869-1.9659.8101.2478 1.4053.6938 1.769 1.2885.1819-1.239.2645-2.4615.2645-3.6674 0-9.3502-5.7535-15.6113-14.3507-15.6113-8.6137 0-14.3507 6.261-14.3507 15.6113 0 1.2059.0827 2.4284.2645 3.6509.3472-.5782.9424-1.0242 1.7525-1.272 1.7525-.5121 3.1743.2643 3.6869 1.9659l2.4469 8.0452c.5125 1.7181-.2645 3.1883-1.984 3.7004-1.3888.3965-2.5792 0-3.2735-1.0573-.4795.1487-.9589-.0165-1.2069-.4791-2.4138-4.2126-3.8357-9.6311-3.8357-14.554 0-10.6883 6.5471-17.7588 16.5-17.7588z" fill="#1d1d1f" /></svg>                    </div>
                    <div><p className="pt-1  text-center">配件</p></div>
                </div>
                <div className=" cursor-pointer">
                    <div>
                        <svg className=" my-0 mx-auto" width="36" viewBox="0 0 35 54" xmlns="http://www.w3.org/2000/svg"><path d="m16.3 36.64c0 2.86-1.49 4.66-3.87 4.66s-3.87-1.81-3.87-4.66c0-2.87 1.49-4.67 3.87-4.67s3.87 1.8 3.87 4.67zm3.32-10.09-1.04.07c-.59.04-.85.25-.85.63 0 .4.33.62.79.62.63 0 1.1-.41 1.1-.96zm14.88 6.45c0 9.49-7.51 17-17 17s-17-7.51-17-17 7.51-17 17-17 17 7.51 17 17zm-13.06-6.66c0 1.38.76 2.22 2 2.22 1.05 0 1.71-.59 1.82-1.43h-.82c-.11.46-.47.71-1 .71-.7 0-1.13-.57-1.13-1.5 0-.92.43-1.47 1.13-1.47.56 0 .91.32 1 .73h.82c-.11-.82-.75-1.44-1.82-1.44-1.24-.01-2 .83-2 2.18zm-11.43-2.1v4.24h.84v-2.6c0-.55.39-.99.9-.99.5 0 .82.3.82.78v2.81h.82v-2.68c0-.51.35-.91.9-.91s.82.28.82.87v2.72h.84v-2.93c0-.88-.5-1.4-1.36-1.4-.59 0-1.08.3-1.29.76h-.07c-.19-.46-.59-.76-1.17-.76-.57 0-1 .28-1.18.76h-.06v-.68zm7.78 12.4c0-3.69-2.06-6.01-5.36-6.01s-5.36 2.32-5.36 6.01 2.06 6 5.36 6 5.36-2.32 5.36-6zm.52-8.09c.56 0 1.02-.24 1.28-.67h.07v.6h.81v-2.9c0-.89-.6-1.42-1.67-1.42-.97 0-1.65.47-1.74 1.18h.81c.09-.31.42-.48.89-.48.57 0 .87.26.87.73v.37l-1.15.07c-1.01.06-1.58.5-1.58 1.27-.01.76.59 1.25 1.41 1.25zm9.17 10.59c0-1.65-.96-2.61-3.38-3.14l-1.29-.28c-1.59-.35-2.21-.98-2.21-1.89 0-1.18 1.12-1.89 2.57-1.89 1.52 0 2.52.78 2.65 2.06h1.45c-.07-1.97-1.74-3.36-4.06-3.36-2.41 0-4.1 1.35-4.1 3.26 0 1.65 1.01 2.71 3.34 3.22l1.29.28c1.61.35 2.26 1 2.26 1.97 0 1.14-1.15 1.97-2.72 1.97-1.67 0-2.83-.76-3-2.01h-1.45c.14 2.01 1.83 3.31 4.37 3.31 2.59 0 4.28-1.35 4.28-3.5z" fill="#1d1d1f" /></svg>                    </div>
                    <div><p className="pt-1  text-center">Sonoma</p></div>
                </div>

                <div className=" cursor-pointer">
                    <div><svg height="56" viewBox="0 0 108 56" width="108" xmlns="http://www.w3.org/2000/svg"><path d="m0 0h108v56h-108z" fill="none" /><path d="m1.75 28v-.5c0-.9648.7852-1.75 1.75-1.75h22.5v-1.75h-23.5c-1.3807 0-2.5 1.1193-2.5 2.5v3.25c.9648 0 1.75-.7852 1.75-1.75zm71.25-10.5v24c0 .8284-.6716 1.5-1.5 1.5h-43c-.8284 0-1.5-.6716-1.5-1.5v-24c0-.8284.6716-1.5 1.5-1.5h43c.8284 0 1.5.6716 1.5 1.5zm-2 .5h-42v23h42zm-27 26v8h12v-8.5h-12zm-3 0v5.5c0 1.3807-1.1193 2.5-2.5 2.5h-36c-1.3807 0-2.5-1.1193-2.5-2.5v-19.25c1.2402 0 2.25-1.0093 2.25-2.25v-.5c0-.6895.5605-1.25 1.25-1.25h22.5v15.25c0 1.3785 1.1215 2.5 2.5 2.5zm-20.5088-7.1858c0 .0322 0 .0541.001.0665.0027.0183.0244.0244.0674.0244.104 0 .2065-.0262.3064-.0814.1013-.0541.1907-.1269.2705-.2205.0813-.0911.1426-.1953.1907-.3116.0474-.1174.0728-.2347.0728-.3503v-.0489c0-.014-.0017-.0289-.0071-.0455-.1173.007-.2328.0367-.3423.0953-.1104.0595-.2065.1366-.2861.2241-.085.0938-.1481.1979-.1987.3099-.0491.1138-.0745.225-.0745.338zm1.8409 2.3922c-.1909-.0839-.3397-.2108-.4447-.3781-.1077-.1664-.1593-.3492-.1593-.5505 0-.1918.0385-.3616.1128-.5025.078-.1436.2023-.2661.3722-.3686-.092-.14-.219-.2502-.3765-.3334-.161-.085-.3247-.127-.5017-.127-.0656 0-.1294.0079-.1924.0219-.0623.014-.1428.0394-.2478.0753-.106.0403-.1908.0692-.2478.0893-.0542.021-.0927.0306-.1145.0306-.0632 0-.1716-.0342-.3282-.1024-.1594-.0658-.2977-.0999-.415-.0999-.1586 0-.3064.0341-.4403.0999-.1348.0681-.2521.161-.3545.2852-.1016.1208-.183.268-.2407.4333-.0576.1673-.0858.3494-.0858.5453 0 .1279.0148.2574.0377.3923.0209.1357.0542.2678.0938.399.04.1348.0935.2617.1497.387.061.1225.1216.2363.1925.3395.0753.1121.1436.2031.2074.2775.0613.0753.1165.1348.1725.1794.056.0438.1093.0762.161.0963.05.0175.1007.027.1584.027.0359 0 .0892-.0095.1479-.027.0579-.0201.1243-.0395.196-.0629.0692-.0228.1393-.0447.2109-.064.0684-.0219.1349-.0306.1943-.0306.0553 0 .1139.0088.1838.0264.0664.0219.1339.041.2013.0629.0665.0219.1305.0421.1952.0613.0623.0185.1166.028.1611.028.0701 0 .1365-.0131.1987-.0471.0664-.0334.1287-.0789.1917-.1314.0306-.0341.0771-.0832.1357-.1522.0533-.0692.1111-.1515.1715-.2435.057-.0892.1121-.1916.1664-.2985.0525-.1085.0989-.2232.1366-.338zm80.6678 10.7936v-24.2708c-.0114-.9617-1.0382-1.7178-2-1.7292h-27v1.5h6.121c.0365.5364.3425.9635.879 1h3c.5209.0314.9686-.4792 1-1 .0023-.0379.0023.0171 0-.0208l16 .0208c.3999 0 .5.1.5.5v24h-38v-6h-1.5v6h-4.5v.55c-.0089.5179.484.9046 1 .95h2.121l.5.5h3l.5-.5h35.7582l.4501.5h3l.5499-.45 2.1208-.05c.5283.0118.9308-.3261 1-.85v-.65z" fill="#1d1d1f" /></svg></div>
                    <div><p className="pt-1  text-center">选购 Mac</p></div>
                </div>

            </div>
            <div className=" py-12 px-12 bg-white h-[78rem] flex flex-col items-center">
                <div className=" an-test2 w-full 2xl:w-[120rem] flex flex-row justify-between ">
                    <div className="text-8xl font-bold">Mac</div>
                    <div className=" text-4xl "><p>你想的出，</p><p>Mac助你做得到。</p></div>
                </div>
                <div className="mt-16 2xl:w-[120rem] 2xl:h-[47rem] rounded-[3rem] overflow-hidden ">
            ...
            <div className=" p-12 bg-gray-50">
                ...
                <div>
                    <div className="flex w-[23.435rem] h-[2.5rem] bg-white justify-between items-center rounded-full">
                        <div onClick={() => setCurrentMenu(0)}  className={` cursor-pointer h-full leading-[2.5rem] px-6 rounded-full ${currentMenu == 0 ? 'bg-black text-white ':''}`}>笔记本电脑</div>
                        <div onClick={() => setCurrentMenu(1)}  className={` cursor-pointer h-full leading-[2.5rem] px-6 rounded-full ${currentMenu == 1 ? 'bg-black text-white ':''}`}>台式电脑</div>
                        <div onClick={() => setCurrentMenu(2)}  className={` cursor-pointer h-full leading-[2.5rem] px-6 rounded-full ${currentMenu == 2 ? 'bg-black text-white ':''}`}>显示器</div>
                    </div>
                    <div>
